...
plt.title( "Précision sur l'ensemble de validation en \n fonction du nombre de points de la classe 1")
plt.xlabel("Nombre de points de la classe 1")
...
plt.figure()
plt.plot(nbClass,preci)
plt.title( "Précision sur l'ensemble de validation en \n fonction du nombre de points de la classe 2")
plt.xlabel("Nombre de points de la classe 2")
plt.ylabel("Précision")
